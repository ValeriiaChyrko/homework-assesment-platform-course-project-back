...
public class AssignmentProgressController(IAssignmentProgressService service, HybridCache cache, ICacheKeyManager cacheKeyManager) : BaseController
{
    ...
    /// </summary>
    [HttpGet("progress")]
    public async Task<ActionResult<RespondAssignmentUserProgressDto>> GetProgress(Guid courseId, Guid chapterId, Guid assignmentId,
    ...
    public async Task<ActionResult<IReadOnlyList<string>>> FinishAssignment(Guid courseId, Guid chapterId, Guid assignmentId,
        CancellationToken cancellationToken = default)
    {
        var userId = GetUserId();
    ...
    public async Task<ActionResult<IReadOnlyList<string>>> RestoreAssignment(Guid courseId, Guid chapterId, Guid assignmentId,
        CancellationToken cancellationToken = default)
    {
        var userId = GetUserId();
