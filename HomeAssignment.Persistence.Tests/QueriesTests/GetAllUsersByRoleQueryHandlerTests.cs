...
[TestFixture]
public class GetAllUsersByRoleQueryHandlerTests
{
    private IHomeworkAssignmentDbContext _mockContext;
    private IMapper _mapper;
    private GetAllUsersByRoleQueryHandler _handler;
    ...
    public void Setup()
    {
        ...
        _handler = new GetAllUsersByRoleQueryHandler(_mockContext, _mapper);
    }

    [Test]
    public void Constructor_Should_Throw_ArgumentNullException_When_Context_Is_Null()
    {
        Action act = () => new GetAllUsersByRoleQueryHandler(null!, _mapper);
    ...
    {
        Action act = () => new GetAllUsersByRoleQueryHandler(_mockContext, null!);
