...
public class DockerService : IDockerService
{
    ...
    public async Task<ProcessResult> RunCommandAsync(string repositoryPath, string workingDirectory, string dockerImage, string command, string? arguments, CancellationToken cancellationToken)
    {
