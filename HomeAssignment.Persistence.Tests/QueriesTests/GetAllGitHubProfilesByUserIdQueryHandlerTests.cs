...
[TestFixture]
public class GetAllGitHubProfilesByUserIdQueryHandlerTests
{
    private IHomeworkAssignmentDbContext _mockContext;
    private IMapper _mapper;
    private GetAllGitHubProfilesByUserIdQueryHandler _handler;
    ...
    public void Setup()
    {
        ...
        _handler = new GetAllGitHubProfilesByUserIdQueryHandler(_mockContext, _mapper);
    }

    [Test]
    public void Constructor_Should_Throw_ArgumentNullException_When_Context_Is_Null()
    {
        Action act = () => new GetAllGitHubProfilesByUserIdQueryHandler(null!, _mapper);
    ...
    {
        Action act = () => new GetAllGitHubProfilesByUserIdQueryHandler(_mockContext, null!);
