...
public class RequestUserDtoValidator : AbstractValidator<RequestUserDto>
{
    ...
    public RequestUserDtoValidator()
    {
        RuleFor(x => x.FullName)
            ...
            .MaximumLength(MaxLengthFullNamePropertyLength)
            .WithMessage($"Full Name must not exceed {MaxLengthFullNamePropertyLength} characters.");
        ...
        RuleFor(x => x.GithubUsername)
            ...
            .MaximumLength(MaxLengthGithubUsernamePropertyLength)
            .WithMessage($"GitHub Username must not exceed {MaxLengthGithubUsernamePropertyLength} characters.");
