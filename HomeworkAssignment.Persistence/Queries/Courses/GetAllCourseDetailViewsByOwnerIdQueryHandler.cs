...
{
    public sealed class GetAllCourseDetailViewsByOwnerIdQueryHandler : IRequestHandler<GetAllCourseDetailViewsByOwnerIdQuery, PagedList<CourseDetailView>>
    {
        ...
        public async Task<PagedList<CourseDetailView>> Handle(GetAllCourseDetailViewsByOwnerIdQuery query, CancellationToken cancellationToken)
        {
