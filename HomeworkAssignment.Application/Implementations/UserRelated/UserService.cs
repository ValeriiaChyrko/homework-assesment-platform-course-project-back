...
public class UserService : BaseService<UserService>, IUserService
{
    ...
    public UserService(ILogger<UserService> logger, IDatabaseTransactionManager transactionManager, IMediator mediator, IMapper mapper) : base(logger, transactionManager)
    {
        _logger = logger;
        _mediator = mediator;
        _mapper = mapper;
