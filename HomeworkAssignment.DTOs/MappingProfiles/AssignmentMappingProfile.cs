    ...
    public AssignmentMappingProfile()
    {
        ...
        CreateMap<AssignmentEntity, Assignment>()
            .ConstructUsing(entity => new Assignment(
                ...
                entity.CreatedAt,
                entity.UpdatedAt,
                new ScoreSection(entity.AttemptCompilationSectionEnable, entity.AttemptCompilationMaxScore,
                    entity.AttemptCompilationMinScore),
                new ScoreSection(entity.AttemptTestsSectionEnable, entity.AttemptTestsMaxScore,
                    entity.AttemptTestsMinScore),
                new ScoreSection(entity.AttemptQualitySectionEnable, entity.AttemptQualityMaxScore,
                    entity.AttemptQualityMinScore)
            ))
