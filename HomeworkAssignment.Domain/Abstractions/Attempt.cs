namespace HomeAssignment.Domain.Abstractions
{
        ...
        Guid assignmentId)
    {
        ...
        public static Attempt Create(ushort position, string? branchName, Guid userId, Guid assignmentId)
        {
            return new Attempt(
                Guid.NewGuid(),
                position,
        ...
        public void Submit(ushort compilationScore, ushort qualityScore, ushort testsScore)
        {
